      ...
      setTimeout(() => {
        if (url.includes('error')) {
          ...
          if (ctx) {
            ...
            ctx.fillText('Website Preview', canvas.width / 2, canvas.height / 2 - 50);
            ...
            ctx.fillText('Preview generated by Peruse AI', canvas.width / 2, canvas.height / 2 + 60);
            
            const preview = canvas.toDataURL('image/png').split(',')[1];
            resolve({ preview });
          } else {
            resolve({ error: 'Failed to generate preview' });
          }
        }
      }, 1500);
    });
